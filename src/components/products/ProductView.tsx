...
const ProductView = ({ product }: { product: any }) => {
  ...
  return (
    <div className="flex flex-col self-center bg-white border w-[300px] rounded-xl p-5 gap-2 items-start justify-center">
      <img
        src={product.image}
        alt={product.name}
      ...
      <div className="flex flex-row mt-3 w-full mx-auto justify-center items-center flex-wrap gap-5">
        ...
        <Link href={"/checkout"} className="bg-black text-white font-semibold px-3 py-2 hover:bg-white hover:text-black hover:border hover:border-black border border-black rounded-xl">
          Buy Now
        </Link>
      </div>
    </div>
