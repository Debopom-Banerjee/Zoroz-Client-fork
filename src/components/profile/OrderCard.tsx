    ...
    <div className="flex flex-row flex-wrap justify-between items-center  gap-3 w-full bg-white px-10 py-5 rounded-lg border border-slate-300">
      <div className="flex flex-row items-center gap-5 justify-center">
        ...
        <div className="flex flex-col items-start gap-1 ">
          <Link
            href={`/profile/orders/${orderData?._id}`}
            className="font-semibold text-sm hover:text-red-600"
          >
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <button
          ...
          className="font-semibold text-white bg-red-600 px-5 py-1 rounded-lg border border-red-600 hover:bg-white hover:text-red-600 hover:border-red-600"
        >
          Cancel
        </button>
      </div>
