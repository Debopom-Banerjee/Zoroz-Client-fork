...
const ProductCard = ({ product }: { product: any }) => {
  return (
    <div
      className={`${
        product?.admin_approval ? "border-green-400" : "border-red-600"
      } flex flex-col items-center border-2  w-[300px] bg-slate-200 p-5 gap-4 rounded-md`}
    >
      ...
      <h1
        className={`${
          product?.admin_approval ? "text-green-500" : "text-red-600"
...
const page = () => {
  ...
  useEffect(() => {
    const filteredResults = products.filter((category: any) =>
